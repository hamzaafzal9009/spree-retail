            ...
            <div class="card mb-2">
                <div class="col-12">
                    <div class="row mb-1 mt-1">
                        ...
                        <h5 class="email-card mb-0 mt-2 ml-3">{{ $user->email }}</h5>
                    ...
                    <div class="row mb-1 mt-1">
                        ...
                        <h5 class="email-card mb-0 mt-2 ml-3">{{$address->address}}, {{$address->city}}, {{$address->country}} {{$address->zipcode}}</h5>
...
<script>
    ...
    function update_price(price){
        var total = {{Cart::instance('default')->total()}};

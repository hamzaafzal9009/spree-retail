                ...
                <div class="card-body">
                    <form action="{{route('product.update',$product->slug)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" name="price" value="{{old('price') ?? $product->price}}" type="number" class="form-control @error('price') is-invalid @enderror" placeholder="Price">
                            @error('price')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="length" name="length" value="{{old('length') ?? $product->length}}" type="number" class="form-control @error('length') is-invalid @enderror" placeholder="Length">
                            @error('length')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="width" name="width" value="{{old('width') ?? $product->width}}" type="number" class="form-control @error('width') is-invalid @enderror" placeholder="Width">
                            @error('width')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="height" name="height" value="{{old('height') ?? $product->height}}" type="number" class="form-control @error('height') is-invalid @enderror" placeholder="Height">
                            @error('height')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="weight" name="weight" value="{{old('weight') ?? $product->weight}}" type="number" class="form-control @error('weight') is-invalid @enderror" placeholder="Weight">
                            @error('weight')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>

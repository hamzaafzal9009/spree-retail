                ...
                <div class="card-body">
                    <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="length" name="length" type="number" class="form-control @error('length') is-invalid @enderror" placeholder="Length">
                            @error('length')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="width" name="width" type="number" class="form-control @error('width') is-invalid @enderror" placeholder="Width">
                            @error('width')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="height" name="height" type="number" class="form-control @error('height') is-invalid @enderror" placeholder="Height">
                            @error('height')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="weight" name="weight" type="number" class="form-control @error('weight') is-invalid @enderror" placeholder="Weight">
                            @error('weight')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
